...
`cpt sessions page`, `cpt tasks` and dated price snapshots need 0.7.0; Opus 5.5 and fast mode
prices need 0.8.0. To work from a copy
...
Version 0.8.0 is on PyPI. What has been checked, and how:
...
| Fast mode pricing | rates read from Anthropic's pricing page on 2026-09-26; tested on synthetic transcripts and the fake API server, not yet against an invoice |
